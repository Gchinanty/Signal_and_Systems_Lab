...
% Last Modified by GUIDE v2.5 14-Feb-2019 23:57:55
...
% --- Executes on button press in guidebook.
function guidebook_Callback(hObject, eventdata, handles)
% hObject    handle to guidebook (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
Guidance;
